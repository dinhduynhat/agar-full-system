...
Vec.prototype = {
  ...
  scaleClone: function (s) {return new Vec(this.x * s, this.y * s);},
  normalizeClone: function() {var d = this.length(); return this.scaleClone(1.0/d);},
...
module.exports = {
  Vec: Vec,
  line_point_intersect: line_point_intersect,
